  ...
  return (
    <footer className="mt-12 border-t border-neutral-200 bg-gradient-to-b from-white to-neutral-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="space-y-3 md:space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-display font-bold text-neutral-900 text-sm md:text-base">VBP Paraná</h3>
                <p className="text-[10px] md:text-xs text-neutral-500">Inteligência Territorial</p>
              </div>
            </div>
          ...
          {/* Data Sources */}
          <div className="space-y-3 md:space-y-4">
            <h4 className="font-semibold text-neutral-900 text-sm md:text-base">Fontes de Dados</h4>
            <ul className="space-y-2 text-xs md:text-sm text-neutral-600">
          ...
          {/* Links */}
          <div className="space-y-3 md:space-y-4">
            <h4 className="font-semibold text-neutral-900 text-sm md:text-base">Links</h4>
        ...
        {/* Bottom */}
        <div className="mt-6 md:mt-8 pt-4 md:pt-6 border-t border-neutral-200 flex flex-col sm:flex-row items-center justify-between gap-3 md:gap-4">
          <div className="flex flex-col sm:flex-row items-center gap-2 text-xs text-neutral-500">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 text-neutral-400 hover:text-primary-500 transition-colors group"
